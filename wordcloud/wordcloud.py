...
FONT_PATH = os.environ.get("FONT_PATH", "/usr/share/fonts/truetype/DejaVuSansMono.ttf")
...
class WordCloud(object):
    ...
    def fit_words(self, words):
        ...
        for word, count in words:
            ...
            if not self.ranks_only:
                #font_size = min(font_size, int(1000 * np.log(count + 100)))
                font_size = min(font_size, int(1000  * count ))
            while True:
    ...
    def generate_from_word_sizes(self,words):
        self.fit_words(words)
